...
public class Document {
    ...
    /**
     * Cette méthode nous permet de mettre en majuscules des caractères dans l'intervalle [debut;fin]
     * @param debut
     * @param fin
     */
    ...
    /**
     * Cette méthode nous permet d'effacer des caractère dans l'intervalle [debut;fin]
     * @param debut
     * @param fin
     */
